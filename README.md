# Jolly Ollys Organiser

This is an jolly-ollys organiser that demonstrates how to structure content for an Our Oakley website. It shows how to organise events, venues, and organisers with their associated information.
...
3. Create initial content:
   - Create an jolly-ollys event in `content/events/`
